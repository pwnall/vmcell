//! The vmcell control-plane daemon library (design v21 §D).
//!
...
//! held and are released **on `Drop`** in order (v20 §12.10 — the invariant is preserved). A
...
//! schema is single-sourced without the client pulling the server (design v21 §D1.1).
