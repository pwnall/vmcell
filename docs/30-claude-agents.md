...
`docs/<design>.md` — architecture & the decision record (authoritative). · the review rubric —
the explained version of everything above. · the automation-files doc — the gates and how to
deploy them. · `implementation-notes.md` — the running log of justified deviations; add to it.
