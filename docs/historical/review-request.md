Please read @docs/24-claude-design-v11p1.md and @docs/requirements.md and
@docs/implementation-notes.md to understand what we're working on, where we
are, and where we want to be. Please do not waste your context reading any
other files in docs/.
