Please read the following from `docs/`: latest design doc,
...
report at `docs/72-claude-code-review.md`. Do not attempt to fix any problems.
...
Please avoid suggesting improvements that would regress the latency results
documented in `docs/benchmark-results.md`.
